...
Each subsection adds one component to the continuous Frank-Wolfe pipeline, starting from the hypercube relaxation of the violation objective and ending with conditional-expectations rounding and exact verification.
